 ...
 * Author: 
 * Version: $Id: DebugTerminal.h,v 1.14 1998/12/03 18:10:07 mountcas Exp $
 * Purpose: This is a Terminal object.  It prints its Visitors 
 * and kills them.
 * BUGS:
 */

#ifndef __DEBUG_TERMINAL_H__
#define __DEBUG_TERMINAL_H__

#ifndef LINT
static char const _DebugTerminal_h_rcsid_[] =
"$Id: DebugTerminal.h,v 1.14 1998/12/03 18:10:07 mountcas Exp $";
#endif
...
class DebugTerminal: public Terminal {
public:

  DebugTerminal(const NodeID * n);
