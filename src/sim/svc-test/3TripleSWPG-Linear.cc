...
"$Id: 3TripleSWPG-Linear.cc,v 1.5 1998/09/28 18:39:19 mountcas Exp $";
#endif
...
const double SVC_INT = -1.0; // 0.01;
// Queue depth
const int    QDEPTH  = -1;   // 100;
// Bandwidth
const u_long BW      = OC3;
...
u_char addresses[][22] = {
  ...
  { 96, 160, 0x47, 0x05, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,              // 8
    0x11, 0x11, 0x30, 0x3a, 0x3a, 0x3a, 0x3a, 0x3a, 0x3a, 0x3a, 0x00 },    
  { 96, 160, 0x47, 0x05, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
    0x11, 0x11, 0x30, 0x3b, 0x3b, 0x3b, 0x3b, 0x3b, 0x3b, 0x3b, 0x00 },
  { 96, 160, 0x47, 0x05, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
    0x11, 0x11, 0x30, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x00 },
  // preferred parent
...
void main(int argc, char ** argv)
{
  ...
  DiagLevel("fsm.forwarder",  DIAG_INFO);
