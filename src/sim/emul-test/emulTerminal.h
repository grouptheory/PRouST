...
// -*- C++ -*-
#ifndef __EMULTERMINAL_H__
#define __EMULTERMINAL_H__

#ifndef LINT
static char const _EmulTerminal_h_rcsid_[] =
"$Id: EmulTerminal.h,v 1.2 1998/12/03 18:12:38 mountcas Exp $";
#endif
...
class EmulTerminal : public SwitchTerminal {
public:

  EmulTerminal(const NodeID * n);
