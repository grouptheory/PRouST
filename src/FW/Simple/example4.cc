...
// -*- C++ -*-
#ifndef LINT
static char const _example4_cc_rcsid_[] =
"$Id: example4.cc,v 1.8 1998/08/13 20:13:40 mountcas Exp $";
#endif
...
#define TOKEN_PIPE_IN  "/tmp/tokenpipe_in"
#define TOKEN_PIPE_OUT "/tmp/tokenpipe_out"
...
void main(int argc, char ** argv)
{
  ...
  DiagLevel("FW.kernel.lockstep", DIAG_DEBUG);
