...
#ifndef LINT
static char const _example2_cc_rcsid_[] =
"$Id: example2.cc,v 1.8 1998/08/13 20:13:18 mountcas Exp $";
#endif
...
SimpleTerm * BuildTheNetwork(void)
{
  ...
  SimpleCreator * sc = new SimpleCreator(3);  // This makes the Creator allocate Clusters/Expanders
...
void main(int argc, char ** argv)
{
  ...
  // This enables us to visualize the registry
  theShareableRegistry().save("example2.vis");
